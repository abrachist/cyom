...
class GenerateTransactionModel extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cyom:transaction-model
    ...
    protected function getStub()
    {
        ...
        ? config('cyom.path') . '/model.stub'
        : __DIR__ . '/../../template/transaction/model.stub';
    }
